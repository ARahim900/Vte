#!/bin/bash
# Fix TypeScript errors in RiskFactorAge.tsx
...
echo "git add components/RiskFactorAge.tsx"
echo "git commit -m 'Fix: Remove all unused imports and fix TypeScript errors'"
echo "git push"